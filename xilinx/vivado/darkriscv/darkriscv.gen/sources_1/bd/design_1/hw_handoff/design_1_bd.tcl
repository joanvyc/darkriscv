...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set LED0_0 [ create_bd_port -dir O -from 0 -to 0 LED0_0 ]
  set LED1_0 [ create_bd_port -dir O -from 0 -to 0 LED1_0 ]
  set LED2_0 [ create_bd_port -dir O -from 0 -to 0 LED2_0 ]
  set LED3_0 [ create_bd_port -dir O -from 0 -to 0 LED3_0 ]
  set XRES [ create_bd_port -dir I XRES ]
  ...
  # Create instance: soc_0, and set properties
  set block_name soc
  set block_cell_name soc_0
  if { [catch {set soc_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net xlslice_3_Dout [get_bd_pins ila_0/probe14] [get_bd_pins xlslice_3/Dout]
  connect_bd_net -net xlslice_4_Dout [get_bd_ports LED0_0] [get_bd_pins xlslice_4/Dout]
  connect_bd_net -net xlslice_5_Dout [get_bd_ports LED1_0] [get_bd_pins xlslice_5/Dout]
  connect_bd_net -net xlslice_6_Dout [get_bd_ports LED2_0] [get_bd_pins xlslice_6/Dout]
  connect_bd_net -net xlslice_7_Dout [get_bd_ports LED3_0] [get_bd_pins xlslice_7/Dout]
